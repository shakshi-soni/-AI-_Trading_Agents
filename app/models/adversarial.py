...
class AdversarialReport(BaseModel):
    ...
    verified_facts: dict[str, object] | None = Field(
        default=None,
        description="Python-computed trade facts (strikes, spread width, breakeven, days to expiry) — deterministic, not LLM-generated",
    )
